...
<table>
        <thead>
          <tr>
            ...
            <th scope="col"><i class="fas fa-dollar-sign"></i> Sub Total</th>
...
%>
          <tr>
            ...
            <td><i class="fas fa-dollar-sign"></i> <%=rs.getString(19) %></td>
            <td><%=rs.getString(3) %></td>
            <td><i class="fas fa-dollar-sign"></i> <%=rs.getString(5) %></td>
