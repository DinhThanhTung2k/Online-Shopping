...
<title>Home</title>
<script>
	if(window.history.forward(1) 1= null)
...
%>
          ...
          <th scope="col"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="background-color: yellow;">Total: <i class="fas fa-dollar-sign"></i> <%out.println(total); %></th>
          </tr>
        </thead>
        <thead>
          <tr>
 ...
 %>
          ...
          <%sno = sno + 1;%>
           <td><%out.println(sno); %></td>
            ...
            <td><i class="fas fa-dollar-sign"></i> <%=rs.getString(4) %></td>
            <td> <%=rs.getString(8) %></td>
            <td><i class="fas fa-dollar-sign"></i> <%=rs.getString(10) %></td>
            </tr>
         <% 
         } 
...
<div class="right-div">
<h3>PayPal online on this tunghotboy2017@gmail.com</h3>
